...
### 0. Narrative Spine 작성 (blueprint 작성 전)

슬라이드를 작성하기 전, 전체 스토리를 5~10문장으로 먼저 요약한다.
이 단계에서 발표 흐름의 논리적 정합성을 확인한다.
...
Narrative Spine을 사용자에게 제시하고 승인받은 후 blueprint 작성을 시작한다.
...
deck:
  title: {발표 제목}
  design: teal           # 기본 추천 (dark-first). light 필요 시 design: modern
  theme: dark            # teal/vivid는 dark 우선
  version: "1.0"
  author: {작성자 또는 팀명} # 선택
  audience: {청중} # 선택
```
