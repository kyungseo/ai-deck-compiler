...
Use this skill when the user asks to invoke the workflow skill `health`.
...
- **컨텍스트 절약**: `AGENTS.md`와 `docs/AGENT-WORKFLOW.md`는 세션 시작 시 자동 로드됨 — 재읽기 금지.
...
`docs/STATUS.md` — AGENTS.md·docs/AGENT-WORKFLOW.md는 이미 컨텍스트에 있으므로 스킵.
...
| `docs/GIT-WORKFLOW.md`, branch/release policy 변경 | `docs/AGENT-WORKFLOW.md` | `.claude/commands/work.md`, `close.md`, 대응 SKILL mirror | `README.md`, `docs/HARNESS-QUICK-REFERENCE.md` | `scripts/templates/source-gitflow/docs/GIT-WORKFLOW.md`, generated work/close command | 관련 Work |
...
| `.claude/commands/{x}.md` ↔ `.agents/skills/workflow-{x}/SKILL.md` mirror pair 변경 | `docs/HARNESS-PROTOCOL.md`, `docs/AGENT-WORKFLOW.md` | 대응 pair 전체 | `docs/HARNESS-QUICK-REFERENCE.md`, `README.md` | scaffold 복사 산출물 | 관련 Work/retrospective |
| `.claude/commands/health.md` 또는 `.agents/skills/workflow-health/SKILL.md` 변경 | `docs/AGENT-WORKFLOW.md` | SKILL mirror (또는 command mirror) | `docs/HARNESS-QUICK-REFERENCE.md` `/health` 행, `README.md` | scaffold 복사 산출물 health command/skill | — |
