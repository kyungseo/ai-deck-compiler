...
```text
docs/HARNESS-RECOVERY-VALIDATION.md의 Failure And Recovery 절차에 따라 FAIL 처리해줘.
```
...
상세 기준은 docs/HARNESS-RECOVERY-VALIDATION.md의 Failure And Recovery와 Validation Checklist를 따라줘.
```
